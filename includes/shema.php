...
if ($updateManager->isInstall()){
	...
	// $catalogManager->ElementOptionAppend(0, 0, 2, 'price_opt', 'Цена оптовая', '', 0, '{"cst":{"en":0,"inpen":0,"inp":"","onlden":0,"onld":""},"size":"10,2","def":"0"}');
	// $catalogManager->ElementOptionAppend(0, 0, 2, 'price3', 'Цена 3', '', 0, '{"cst":{"en":0,"inpen":0,"inp":"","onlden":0,"onld":""},"size":"10,2","def":"0"}');
	// $catalogManager->ElementOptionAppend(0, 0, 2, 'price4', 'Цена 4', '', 0, '{"cst":{"en":0,"inpen":0,"inp":"","onlden":0,"onld":""},"size":"10,2","def":"0"}');
