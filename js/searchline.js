...
Component.entryPoint = function(NS){
	...
	var Autocomplete = function(input, container){
	...
	NS.API.searchLineInit = function(){
		...
		for (var i=0;i<elCont.length;i++){
			var elInput = Dom.getElementsByClassName('sinput', 'input', elCont[i]),
				elLoading = Dom.getElementsByClassName('loading', '', elCont[i]),
				elAc = Dom.getElementsByClassName('autocompletecont', '', elCont[i]);
